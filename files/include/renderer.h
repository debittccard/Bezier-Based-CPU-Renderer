...
Pixel *get_framebuffer(void);

void draw_pixel(int x, int y, float depth,
...
void render_tube(BezierCubic b,
                 Mat4 mvp,
                 int segments,
                 int sides,
                 float radius,
...
void render_tube_shadow(BezierCubic b,
                        Mat4 light_mvp,
                        int segments,
                        int sides,
                        float radius);

void render_tube_shadow_local(BezierCubic b,
                              Mat4 light_mvp,
                              int segments,
                              int sides,
                              float radius,
